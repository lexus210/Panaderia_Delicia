...
import imgBanner from '../assets/nosotros-banner.jpg';
import imgHistoria from '../jpg/n4.jpg';
import imgCalidad from '../jpg/n1.jpg';
import imgPasion from '../jpg/n2.jpg';
import imgComunidad from '../jpg/n3.jpg';
import fondo from '../jpg/fondo2.jpg';

const Nosotros = () => {
  return (
    <div
      className="bg-cover bg-fixed bg-center min-h-screen text-gray-900"
      style={{ backgroundImage: `url(${fondo})` }}
    >
      {/* Banner principal */}
      <header
        className="relative bg-cover bg-center h-[500px] flex items-center justify-center rounded-b-3xl shadow-lg overflow-hidden"
        ...
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <div className="p-8 bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all">
              <img src={imgCalidad} alt="Calidad" className="mx-auto mb-6 w-24 h-24" />
              <h3 className="text-2xl font-bold mb-4 text-pink-500">Calidad</h3>
              <p className="text-gray-600">
                Seleccionamos los mejores ingredientes para ofrecer productos frescos, saludables y deliciosos.
              </p>
            </div>
            <div className="p-8 bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all">
              <img src={imgPasion} alt="Pasión" className="mx-auto mb-6 w-24 h-24" />
              <h3 className="text-2xl font-bold mb-4 text-pink-500">Pasión</h3>
              <p className="text-gray-600">
                Amamos lo que hacemos y transmitimos esa pasión en cada dulce que preparamos.
              </p>
            </div>
            <div className="p-8 bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all">
              <img src={imgComunidad} alt="Comunidad" className="mx-auto mb-6 w-24 h-24" />
              <h3 className="text-2xl font-bold mb-4 text-pink-500">Comunidad</h3>
              <p className="text-gray-600">
                Somos parte de la comunidad, apoyamos el comercio local y buscamos crear espacios de encuentro.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-r from-pink-400 via-pink-500 to-pink-600 text-white text-center rounded-tl-3xl rounded-br-3xl shadow-2xl mx-6 my-20">
        ...
        <a
          href="/"
          className="bg-white text-pink-600 font-bold px-12 py-4 rounded-full shadow-lg hover:bg-pink-100 transition-all text-xl hover:scale-105 transform duration-300"
        >
